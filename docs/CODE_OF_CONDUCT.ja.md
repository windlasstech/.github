...
[English](../CODE_OF_CONDUCT.md) | [한국어](CODE_OF_CONDUCT.ko.md) | [简体中文](CODE_OF_CONDUCT.zh-cn.md) | 日本語 | [Español](CODE_OF_CONDUCT.es.md) | [Deutsch](CODE_OF_CONDUCT.de.md) | [Français](CODE_OF_CONDUCT.fr.md) | [বাংলা](CODE_OF_CONDUCT.bn.md) | [Magyar](CODE_OF_CONDUCT.hu.md)
...
問題が発生した場合は、速やかに報告することが重要です。本行動規範に反する可能性のある行為については、**[oss-conduct@windlasstech.com](mailto:oss-conduct@windlasstech.com)宛てにメールで報告してください**。
